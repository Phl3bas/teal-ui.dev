...
<html>
  <head>
    <link
      rel="stylesheet"
      href="https://unpkg.com/@tealeaf/tokens@x.x.x/tealeaf-tokens.css"
    />
...
<ExampleCard>
  ...
  <p>Step 2. - Add a <code>:root</code> pseudo element at the top of your stylesheet and override the tokens values.</p>
