...
const NavListItem = ({ title, path }: NavListItemProps) => {
  ...
  return (
    <li>
      <Link
        className="text-decoration-none text-h5 flex-col pl-14  @lg:w-11/12 @lg:text-body text-cool-grey-600 text-cool-grey-600:visited text-black-200:hover bg-teal-000:hover px-0 py-3"
        to={path}
